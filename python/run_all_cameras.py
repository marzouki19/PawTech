...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--follow-x-threshold", type=float, default=0.15)
    parser.add_argument("--follow-y-threshold", type=float, default=0.18)
    parser.add_argument("--lost-stop-frames", type=int, default=10)
