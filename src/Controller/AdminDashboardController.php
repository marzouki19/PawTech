...
class AdminDashboardController extends AbstractController
{
    ...
    #[Route('/cameras/api/list', name: 'app_admin_cameras_api_list', methods: ['GET'])]
    public function listCamerasApi(
        Request $request,
        IpCameraRepository $cameraRepo,
        ...
        $cameras = $status ? $cameraRepo->findBy(['status' => $status]) : $cameraRepo->findAll();
        $data = [];
        ...
        foreach ($cameras as $camera) {
            $data[] = [
                ...
                'stationId' => $camera->getStation()?->getId(),
                ...
                'ptzControlUrl' => $urlGenerator->generate(
                    'app_admin_stations_cameras_control',
                    ['id' => $camera->getId()],
