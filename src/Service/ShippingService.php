...
class ShippingService
{
     ...
     *
     * @return array{cost: float|int, free: bool, zone: array{name: string, multiplier: float, days: string}, delivery_days: string, breakdown?: array{base: int, weight_charge: float|int, multiplier: float}}
     */
     ...
     *
     * @return array<string, array{name: string, multiplier: float, days: string}>
     */
     ...
     *
     * @return array{name: string, multiplier: float, days: string}
     */
     ...
     *
     * @return array{tracking_number: string, status: array{label: string, description: string}, estimated_delivery: string, history: array<int, array{status: array{label: string, description: string}, timestamp: string}>}
     */
     ...
     *
     * @return array{standard: array{cost: float|int, free: bool, zone: array{name: string, multiplier: float, days: string}, delivery_days: string, breakdown?: array{base: int, weight_charge: float|int, multiplier: float}}, express: array{cost: float|int, delivery_days: string, multiplier: int}}
     */
    public function calculateExpressShipping(float $orderTotal, float $totalWeight = 0): array
    {
        ...
        /** @var float|int $standardCost */
        $standardCost = $standard['cost'];
        $expressCost = $standardCost * 2;
