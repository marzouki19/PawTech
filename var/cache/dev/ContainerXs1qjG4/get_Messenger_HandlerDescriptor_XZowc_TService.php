...
class get_Messenger_HandlerDescriptor_XZowc_TService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Messenger\Handler\HandlerDescriptor(new \Symfony\Component\Notifier\Messenger\MessageHandler($a), []);

        if (isset($container->privates['.messenger.handler_descriptor.XZowc.T'])) {
            return $container->privates['.messenger.handler_descriptor.XZowc.T'];
        }

        return $container->privates['.messenger.handler_descriptor.XZowc.T'] = $instance;
    }
}
