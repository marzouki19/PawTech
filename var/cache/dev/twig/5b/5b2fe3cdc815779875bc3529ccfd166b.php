        ...
        <div class=\"overflow-x-auto\">
            <table class=\"min-w-full text-sm\" id=\"t\">
                ...
                <tbody id=\"all\" class=\"divide-y divide-gray-100\">
                    ";
        // line 86
        if ((($tmp =  !Twig\Extension\CoreExtension::testEmpty((isset($context["suivis"]) || array_key_exists("suivis", $context) ? $context["suivis"] : (function () { throw new RuntimeError('Variable "suivis" does not exist.', 86, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 87
            yield "                        ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["suivis"]) || array_key_exists("suivis", $context) ? $context["suivis"] : (function () { throw new RuntimeError('Variable "suivis" does not exist.', 87, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["suivi"]) {
                // line 88
                yield "                        <tr id=\"suivi-";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "id", [], "any", false, false, false, 88), "html", null, true);
                yield "\" class=\"text-gray-700 hover:bg-gray-50\">
                            <td class=\"px-6 py-4 whitespace-nowrap\"><span class=\"font-bold text-gray-900\">#";
                // line 89
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "id", [], "any", false, false, false, 89), "html", null, true);
                yield "</span></td>
                            <td class=\"px-6 py-4 whitespace-nowrap\">
                                <span class=\"inline-flex items-center px-3 py-1 rounded-full text-xs font-medium 
                                    ";
                // line 92
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "etat", [], "any", false, false, false, 92) == "Planifié")) {
                    yield "bg-yellow-100 text-yellow-800
                                    ";
                } elseif ((CoreExtension::getAttribute($this->env, $this->source,                 // line 93
$context["suivi"], "etat", [], "any", false, false, false, 93) == "En cours")) {
                    yield "bg-blue-100 text-blue-800
                                    ";
                } elseif ((CoreExtension::getAttribute($this->env, $this->source,                 // line 94
$context["suivi"], "etat", [], "any", false, false, false, 94) == "Terminé")) {
                    yield "bg-green-100 text-green-800
                                    ";
                } elseif ((CoreExtension::getAttribute($this->env, $this->source,                 // line 95
$context["suivi"], "etat", [], "any", false, false, false, 95) == "Annulé")) {
                ...
                yield "\">
                                    ";
                // line 97
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "etat", [], "any", false, false, false, 97), "html", null, true);
                yield "
                                </span>
                            </td>
                            <td class=\"px-6 py-4 whitespace-nowrap text-gray-900\">";
                // line 100
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "type", [], "any", false, false, false, 100), "html", null, true);
                yield "</td>
                            <td class=\"px-6 py-4 whitespace-nowrap\">
                                ";
                // line 102
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "prochaineVisite", [], "any", false, false, false, 102)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 103
                    yield "                                    <span class=\"font-medium text-blue-600\">";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "prochaineVisite", [], "any", false, false, false, 103), "d/m/Y H:i"), "html", null, true);
                    yield "</span>
                                ";
                } else {
                    // line 105
                ...
                yield "                            </td>
                            <td class=\"px-6 py-4 whitespace-nowrap\">
                                ";
                // line 109
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "consultation", [], "any", false, false, false, 109)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 110
                    yield "                                    <div class=\"flex flex-col\">
                                        <span class=\"font-medium text-gray-900\">Consultation #";
                    // line 111
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "consultation", [], "any", false, false, false, 111), "id", [], "any", false, false, false, 111), "html", null, true);
                    yield "</span>
                                        ";
                    // line 112
                    if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "consultation", [], "any", false, false, false, 112), "dog", [], "any", false, false, false, 112)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                        // line 113
                        yield "                                            <span class=\"text-sm text-gray-500\">";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "consultation", [], "any", false, false, false, 113), "dog", [], "any", false, false, false, 113), "name", [], "any", false, false, false, 113), "html", null, true);
                        yield "</span>
                                        ";
                    }
                    // line 115
                ...
                // line 121
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "recommandation", [], "any", false, false, false, 121), "html", null, true);
                yield "\">
                                    ";
                // line 122
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "recommandation", [], "any", false, false, false, 122), 0, 50), "html", null, true);
                yield "...
                                </div>
                            </td>
                            <td class=\"px-6 py-4 whitespace-nowrap\">
                                <div class=\"flex space-x-2\">
                                    ...
                                    <a href=\"/suivi/";
                // line 128
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "id", [], "any", false, false, false, 128), "html", null, true);
                yield "/edit\" class=\"text-blue-600 hover:text-blue-900\">Edit</a>
                                    ...
                                    <button 
                                        ...
                                        data-id=\"";
                // line 133
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "id", [], "any", false, false, false, 133), "html", null, true);
                yield "\"
                                        data-type=\"";
                // line 134
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["suivi"], "type", [], "any", false, false, false, 134), "html", null, true);
                yield "\"
                                    >
                                        Delete
                                    </button>
            ...
            yield "                    <tr id=\"noResultsRow\">
                        <td colspan=\"7\" class=\"px-6 py-8 text-center text-gray-500\">No follow-ups found.</td>
                    </tr>
                    ";
        }
        // line 147
...
";
    ...
    {
        return array (  353 => 159,  340 => 158,  320 => 147,  314 => 143,  311 => 142,  297 => 134,  293 => 133,  285 => 128,  276 => 122,  272 => 121,  268 => 119,  264 => 117,  260 => 115,  254 => 113,  252 => 112,  248 => 111,  245 => 110,  243 => 109,  239 => 107,  235 => 105,  229 => 103,  227 => 102,  222 => 100,  216 => 97,  211 => 96,  206 => 95,  202 => 94,  198 => 93,  194 => 92,  188 => 89,  183 => 88,  178 => 87,  176 => 86,  140 => 53,  107 => 23,  99 => 18,  91 => 13,  83 => 8,  77 => 4,  64 => 3,  41 => 1,);
    }
                        ...
                        <tr id=\"suivi-{{ suivi.id }}\" class=\"text-gray-700 hover:bg-gray-50\">
                            ...
                            <td class=\"px-6 py-4 whitespace-nowrap\">
                                {% if suivi.consultation %}
                                    <div class=\"flex flex-col\">
                                        <span class=\"font-medium text-gray-900\">Consultation #{{ suivi.consultation.id }}</span>
...
{% endblock %}", "suivi/index.html.twig", "C:\\Users\\nourw\\Documents\\PI-WEB-final\\PI-WEB-final\\templates\\suivi\\index.html.twig");
    }
}
