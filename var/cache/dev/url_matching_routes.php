...
return [
    ...
    [ // $dynamicRoutes
        ...
        255 => [[['_route' => 'app_consultation_delete', '_controller' => 'App\\Controller\\ConsultationController::delete'], ['id'], ['DELETE' => 0], null, false, true, null]],
        287 => [[['_route' => 'app_suivi_edit', '_controller' => 'App\\Controller\\SuiviController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        310 => [
            [['_route' => 'app_suivi_delete', '_controller' => 'App\\Controller\\SuiviController::delete'], ['id'], ['DELETE' => 0], null, false, true, null],
