 ...
 */
class get_ServiceLocator_JFCUEjService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.JFCU_Ej'])) {
            return $container->privates['.service_locator.JFCU_Ej'];
        }

        return $container->privates['.service_locator.JFCU_Ej'] = $instance;
    }
}
