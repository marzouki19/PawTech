...
class get_ServiceLocator_RvMNZGhService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.rvMNZGh'])) {
            return $container->privates['.service_locator.rvMNZGh'];
        }

        return $container->privates['.service_locator.rvMNZGh'] = $instance;
    }
}
